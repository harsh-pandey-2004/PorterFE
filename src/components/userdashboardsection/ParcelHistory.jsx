      ...
      {parcelList.length === 0 ? (
        ...
        <ul className="space-y-4">
          {parcelList.map((parcel) => (
            <li key={parcel._id} className="border border-gray-300 p-4 rounded-md shadow-sm bg-[#F5F5F5] hover:bg-[#E0E0E0] transition duration-200 ease-in-out">
              <h3 className="text-lg font-semibold text-[#1D3557]">
                Tracking Number: <span className="text-[#4CAF50]">{parcel.trackingNumber}</span>
              </h3>
              <p className="text-gray-700"><strong>From:</strong> {parcel.from}</p>
              <p className="text-gray-700"><strong>To:</strong> {parcel.to}</p>
              <p className="text-gray-700"><strong>Product Type:</strong> {parcel.productType}</p>
              <p className="text-gray-700"><strong>Urgency:</strong> {parcel.serviceLevel}</p>
              <p className="text-gray-700"><strong>Transport Type:</strong> {parcel.vehicleType}</p>
              <p className="text-gray-700"><strong>Price:</strong> Rs.{parcel.price}</p>
              <p className="text-gray-700">
                <strong>Created At:</strong> {new Date(parcel.createdAt).toLocaleString()}
              </p>
            </li>
